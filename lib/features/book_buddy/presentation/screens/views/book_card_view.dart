...
import 'package:book_buddy/core/widgets/global_snack_bar.dart';
...
class BookCardView extends StatelessWidget {
  const BookCardView({super.key, required this.bookEntity});
            ...
            child: IconButton(
              onPressed: () {
                context.read<FavouriteBookBloc>().add(
                  FavouriteBookEventInsert(bookEntity: bookEntity),
                );

                GlobalSnackBar.show(context: context, message: 'Added to the favourite!');
              },
